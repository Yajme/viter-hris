...
const UsersList = ({ setItemEdit, itemEdit }) => {
  ...
  const {
    ...
    queryKey: ["users", searchValue, store.isSearch, filterData],
    queryFn: async ({ pageParam = 1 }) =>
      await queryDataInfinite(
        `${apiVersion}/controllers/dev/settings/users/page.php?start=${pageParam}`,
        `${apiVersion}/controllers/dev/settings/users/page.php?start=${pageParam}`, // list endpoint
  ...
  return (
    <>
      ...
      {store.isRestore && (
        <ModalRestore
          mysqlApiRestore={`${apiVersion}/controllers/dev/settings/users/users.php?id=${itemEdit.users_aid}&action=archive`}
          dataItem={itemEdit}
          queryKey={"users"}
      ...
      {store.isDelete && (
        <ModalDelete
          mysqlApiDelete={`${apiVersion}/controllers/dev/settings/users/users.php?id=${itemEdit.users_aid}`}
          dataItem={itemEdit}
          queryKey={"users"}
      ...
      {store.isArchive && (
        <ModalArchive
          mysqlApiArchive={`${apiVersion}/controllers/dev/settings/users/users.php?id=${itemEdit.users_aid}&action=archive`}
          dataItem={itemEdit}
          queryKey={"users"}
